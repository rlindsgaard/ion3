...
mod_statusbar.create{
    ...
    -- windows and icons.
    --
    --template="[ INBOX: %maildir_INBOX_new Mediastyle: %maildir_MEDIASTYLE_new Dikutal: %maildir_DIKUTAL_new Kantine: %maildir_KANTINE_new Revy: %maildir_REVY_new Revyboss: %maildir_REVYBOSS_new ] %filler [ Battery: %laptopstatus_batterypercent  %laptopstatus_batterytimeleft left ] %systray %date",
    template="%filler [ Battery: %laptopstatus_batterypercent  %laptopstatus_batterytimeleft left | Connected to: %iwinfo_ssid IP: %inetaddr Quality: %iwinfo_linkq ] %systray %date",
