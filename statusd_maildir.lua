...
statusd_maildir = {
  ...
  maildirs = {
    INBOX = "~/Maildir/inbox",
    MEDIASTYLE = "~/Maildir/mediastyle/ronni",
    KANTINE = "~/Maildir/lists/diku/kantine",
    REVY = "~/Maildir/lists/diku/revy",
    REVYBOSS = "~/Maildir/lists/diku/revyboss",
    DIKUTAL = "~/Maildir/lists/diku/dikutal"
  },
}
