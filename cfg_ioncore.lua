...
--    kpress(META.."0", "WScreen.switch_nth(_, 9)"),
    kpress(META.."Q","WScreen.switch_prev(_)"),
    kpress(META.."W","WScreen.switch_next(_)"),
    ...
    kpress(META.."Delete","ioncore.exec_on(_, ioncore.lookup_script('ion-lock'))"),
    ...
    -- with tilings.
    kpress("Mod1+Tab", "ioncore.goto_next(_chld, 'up')", 
           "_chld:non-nil"),
    kpress("Mod1+Q","ioncore.goto_next(_chld, 'left')","_chld:non-nil"),
    kpress("Mod1+W","ioncore.goto_next(_chld, 'right')","_chld:non-nil"),
